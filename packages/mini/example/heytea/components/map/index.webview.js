...
var tKJ=_n('view')
_rz(z,tKJ,'style',1,e,s,gg)
var eLJ=_mz(z,'map',['bindcallouttap',2,'bindmarkertap',1,'class',2,'includePoints',3,'latitude',4,'longitude',5,'markers',6,'scale',7,'showLocation',8,'style',9],[],e,s,gg)
_(tKJ,eLJ)
_(aJJ,tKJ)
}
aJJ.wxXCkey=1
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_27();		__wxAppCode__['components/map/index.wxss'] = setCssToHead([".",[1],"c-shop-map{width:100%}\n",],undefined,{path:"./components/map/index.wxss"});
		if (__vd_version_info__.delayedGwx) __wxAppCode__['components/map/index.wxml'] = [ $gwx_XC_27, './components/map/index.wxml' ];
		else __wxAppCode__['components/map/index.wxml'] = $gwx_XC_27( './components/map/index.wxml' );
